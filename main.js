...
console.log(productosDAO.productsInStockMore(20).length);

console.log('2) Número de productos con existencia menos a 15.');
console.log(productosDAO.productsInStockLess(15).length);
...
console.log(productosDAO.productsSameCategory('utensilios de cocina').length);
